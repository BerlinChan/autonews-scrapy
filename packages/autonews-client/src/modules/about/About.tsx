...
import logoAutoNews from "./logo-autonews.png";
    ...
    <div className={cls.about}>
      <div className={cls.header}>
        ...
        <div className={cls.content}>
          ...
          <p>
            新闻源监控系统(Auto News
            System)，是一个实时监控、收录新闻更新的工具，主要功能如下：
          </p>
          <ul>
            <li>
      ...
      <div className={cls.block + " " + cls.origin}>
        ...
        <ul>
          <li>
            <a href="http://hb.qq.com/" target="_blank" rel="noreferrer">
              腾讯·大楚网
            </a>
            新闻，包括:
            要闻/宜昌/襄阳/黄石/十堰/孝感/荆门/荆州/黄冈/恩施/随州/潜江/仙桃
          </li>
          <li>
            <a
              href="http://sxwb.cnhubei.com/cache/paper_sxwb.aspx"
              target="_blank"
              rel="noreferrer"
            >
              三峡晚报
          ...
          <li>
            <a
              href="http://ctdsb.cnhubei.com/cache/paper_ctdsb.aspx"
              target="_blank"
              rel="noreferrer"
            >
              楚天都市报
          ...
          <li>
            <a
              href="http://hbrb.cnhubei.com/cache/paper_hbrb.aspx"
              target="_blank"
              rel="noreferrer"
            >
              湖北日报
          ...
          <li>
            <a
              href="http://ctjb.cnhubei.com/cache/paper_ctjb.aspx"
              target="_blank"
              rel="noreferrer"
            >
              楚天金报
          ...
          <li>
            <a
              href="http://ctdsbxy.cnhubei.com/cache/paper_ctdsbxy.aspx"
              target="_blank"
              rel="noreferrer"
            >
              楚天快报
          ...
          <li>
            <a
              href="http://epaper.cnhubei.com/cache/paper_ctsb.aspx"
              target="_blank"
              rel="noreferrer"
            >
              楚天时报
          ...
          <li>
            <a href="http://cjrb.cjn.cn/" target="_blank" rel="noreferrer">
              长江日报
            </a>
          </li>
          <li>
            <a href="http://whwb.cjn.cn/" target="_blank" rel="noreferrer">
              武汉晚报
            </a>
          </li>
          <li>
            <a href="http://whcb.cjn.cn/" target="_blank" rel="noreferrer">
              武汉晨报
            </a>
          </li>
          <li>
            <a href="http://hb.people.com.cn/" target="_blank" rel="noreferrer">
              人民网-湖北频道
            </a>
          </li>
          <li>
            <a
              href="http://www.hsdcw.com/daymap/"
              target="_blank"
              rel="noreferrer"
            >
              黄石日报（待添加）
      ...
      <div className={cls.block + " " + cls.why}>
        ...
        <p>
          现在虽然不做编辑工作，但作为一个 Code for a Better World 的 Web
          Developer，我觉得这会是一项有意义、有挑战的工作。
        </p>
        <p>
        ...
        <p style={{ textAlign: "right" }}>
          Code with <i className={cls.iconLove} /> by&nbsp;
          <a href="http://www.berlinchan.com" target="_blank" rel="noreferrer">
            摄影师陈柏林
          </a>
        </p>
      </div>
        ...
        <ul className={cls.releaseNoteList}>
          <li>
            ...
            <ul>
              ...
              <li>
                系统具有了人工智能 NLP
                特性，包括关键字提取、新闻分类、情感评价。模型都采用 NLP
                工具现成的，在情感评价和新闻分类上的准确率还有待提高。
              </li>
              <li>
                关键字提取使用{" "}
                <a href="https://github.com/hankcs/HanLP">HanLP</a>
              </li>
              <li>
                新闻分类使用 <a href="http://thuctc.thunlp.org/">THUCTC</a>
              </li>
              <li>
                情感评价使用{" "}
                <a href="https://github.com/isnowfy/snownlp">SnowNLP</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                移植爬虫到 scrapy 框架下，移除node
                crawler框架的爬虫，简化目录结构及依赖
              </li>
          ...
          <li>
            ...
            <ul>
              <li>
                放弃进一步使用 Firebase 框架（数据库不支持多条件查询），自建
                mongoDb 数据库用作存储
              </li>
              <li>
